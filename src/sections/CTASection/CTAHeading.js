...
const CTAHeading = (props) => {
  ...
  return (
    <div className="text-center mb-10 sphone:mb-5">
      <h1 className="text-7xl lg:text-6xl sm:text-5xl sphone:text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-primary-200 to-secondary-200 pb-2 mt-64 lg:mt-56 sphone:mt-24 sm:mt-40">
